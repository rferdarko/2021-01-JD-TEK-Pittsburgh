...
public class Main {                              // Main Class
    public static void main(String[] args) {     // main method
        ...
        System.out.println(student.getName());   // Prints out student name
        System.out.println(student.getDateOfBirth());  // Prints students date of birth
        System.out.println(student.hasStudentHousing()); // prints students student housing status
    }
}
