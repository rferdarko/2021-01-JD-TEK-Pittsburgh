...
public class BinaryCalculations {
    ...
    System.out.println();
        ...
        applications to calculate the answer as this will hinder the learning process and your understanding of
    ...
    System.out.println("Binary Number of 1 is: "+ binary1 );

    int numb1 = 8;   // integer to convert
    int divisor1 = 2; // divisor
    int binary_1 = numb1 % divisor1; // divide until quotient is zero
    System.out.println("Binary Number of 8 is: "+ binary_1 );

    // Scanner inputStream = new Scanner(System.in);
    // System.out.println("Enter a single Integer to convert to Binary: ");
    // int userNumber = inputStream.nextInt();
    // System.out.println("The Binary Number is "+ userNumber % 2);

    int num33 = 33;
    while(num33 > 2) {
        num33 = num33 / 2;
    }
    System.out.println("Binary of 33 is "+num33 % 2);

    int num78 = 78;
    while(num78 > 2) {
        num78 = num78 / 2;
    }
    System.out.println("Binary of 78 is "+num78 % 2);

    int num787 = 787;
    while(num787 > 2) {
        num787 = num787 / 2;
    }
    System.out.println("Binary of 787 is "+num787 % 2);
    ...
    System.out.println("Binary of 33987 is "+num33987 % 2);
...
/*
        ...
        the binary string. Do the preceding exercise with the following values:
        225
        1555
        32456
        ...
        operator to derive the decimal and binary values and assign the result to z. Now, with the preceding values,
        use the bitwise | operator to calculate the “or” value between x and y. As before, write a comment that
